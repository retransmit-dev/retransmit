...
export function homeMarkdown(): string {
  return [
    ...
    "",
    "The cloud runs the code in the repo. Same SDK either way.",
    "",
    `- [Retransmit Cloud](${siteConfig.links.app}): no AWS, Twilio, or Meta accounts. Top up a balance and send. No subscription.`,
    `- [Self-hosted](${siteConfig.links.github}): your servers, your provider accounts, your data. Nothing to pay. AGPL-3.0.`,
    "",
