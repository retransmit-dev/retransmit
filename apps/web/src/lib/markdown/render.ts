...
export function homeMarkdown(): string {
  return [
    ...
    "",
    "Email, anywhere. Send transactional email from our cloud or yours.",
    "",
    ...
    "## Webhooks",
    "",
    "Nine event types (sent, delivered, delivery_delayed, opened, clicked, bounced, complained, rejected, failed), signed with HMAC-SHA256 over `timestamp.body` and retried up to 8 times with exponential backoff.",
    "",
    "## Deliverability",
    "",
    ...
    "- Fetch any email by id and read its full event history.",
    "- Scoped bearer API keys you create and revoke from the dashboard.",
    "",
    "## Open source and self-hosting",
    "",
    `The API, dashboard, queue, and SDK live in [one repository](${siteConfig.links.github}) under AGPL-3.0 (the SDK is MIT). Self-hosting is free forever with every feature, using your own Amazon SES credentials. Moving between cloud and self-hosted is a base URL change.`,
    "",
    "## Pricing",
    "",
