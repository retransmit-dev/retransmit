...
import { eachDayOfInterval, eachHourOfInterval, endOfDay, format, startOfDay, subDays } from "date-fns";
...
const METRICS = ["sent", "delivered", "opened", "clicked", "bounced", "complained"] as const;
...
const ZERO_COUNTS = Object.fromEntries(METRICS.map((metric) => [metric, 0])) as Totals;
        ...
        >
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Emails sent, delivered, and opened.</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <CardContent>
                <ChartContainer config={chartConfig} className="aspect-auto h-64 w-full">
                  <LineChart data={data} margin={{ left: 0, right: 12 }}>
                    ...
                    <ChartTooltip
                      content={
                        <ChartTooltipContent indicator="line" labelFormatter={tooltipLabel} />
                      }
                    />
                    <ChartLegend itemSorter={null} content={<ChartLegendContent />} />
