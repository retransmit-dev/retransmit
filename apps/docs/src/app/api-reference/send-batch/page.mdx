...
Track progress with [Get Batch](/api-reference/get-batch), watch the live
...
| --- | --- | --- | --- |
| `emails` | object[] | Yes | 1–10,000 email objects, each with the same fields as [Send Email](/api-reference/send-email). |
